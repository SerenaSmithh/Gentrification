...
my.col <- rep("slategrey", 137)
my.col[pitt$def3.gentrifying == 0] <- "skyblue"
my.col[pitt$gentrifiable == 1] <- "powderblue"
my.col[pitt$def3.gentrifying == 1] <- "orange"
def3.int <- leaflet(pitt) %>%
  addPolygons(
    label=paste("Tract:", pitt$NAME, "Neighborhood:", pitt$neighborhood),
    labelOptions= labelOptions(direction = 'auto'),
    weight=0.5, color = "black", opacity=1, fillOpacity = 0.7, fillColor = my.col
...
my.col <- rep("slategrey", 137)
my.col[pitt$def4.gentrifying == 0] <- "skyblue"
my.col[pitt$gentrifiable == 1] <- "powderblue"
my.col[pitt$def4.gentrifying == 1] <- "orange"
...
my.col <- rep("slategrey", 137)
my.col[pitt$def5.gentrifying == 0] <- "skyblue"
my.col[pitt$gentrifiable == 1] <- "powderblue"
my.col[pitt$def5.gentrifying == 1] <- "orange"
...
my.col <- rep("slategrey", 137)
my.col[pitt$def6.gentrifying == 0] <- "skyblue"
my.col[pitt$gentrifiable == 1] <- "powderblue"
my.col[pitt$def6.gentrifying == 1] <- "orange"
...
my.col <- rep("slategrey", 137)
my.col[pitt$def6.gentrifying2 == 0] <- "skyblue"
my.col[pitt$gentrifiable == 1] <- "powderblue"
my.col[pitt$def6.gentrifying2 == 1] <- "orange"
def6.int <- leaflet(pitt) %>%
  addPolygons(
    label=paste("Tract:", pitt$NAME, "Neighborhood:", pitt$neighborhood),
    labelOptions= labelOptions(direction = 'auto'),
...
my.col <- rep("slategrey", 137)
    my.col[pitt$def9.gentrifying == 0] <- "skyblue"
    my.col[pitt$gentrifiable == 1] <- "powderblue"
    my.col[pitt$def9.gentrifying == 1] <- "orange"
...
my.col <- rep("slategrey", 137)
my.col[pitt$def10.gentrifying == 0] <- "skyblue"
my.col[pitt$gentrifiable == 1] <- "powderblue"
my.col[pitt$def10.gentrifying == 1] <- "orange"
def10.int <- leaflet(pitt) %>%
  ...
  addLegend(
    title = "Definition 10 - Increasing", 
    position = c("bottomleft"),
    colors = c("orange", "skyblue", "powderblue", "slategrey"),
    labels = c("Gentrifying", "Non-Gentrifying", "Gentrifiable Non-Gentrifying", "Tract Data Missing")
  )
...
def10.int <- leaflet(pitt) %>%
  ...
  addLegend(
    title = "Definition 10 - Decreasing", 
    position = c("bottomleft"),
    colors = c("orange", "skyblue", "powderblue", "slategrey"),
    labels = c("Gentrifying", "Non-Gentrifying", "Gentrifiable Non-Gentrifying", "Tract Data Missing")
  )
...
my.col <- rep("slategrey", 137)
my.col[pitt$def11.gentrifying == 0] <- "skyblue"
my.col[pitt$gentrifiable == 1] <- "powderblue"
my.col[pitt$def11.gentrifying == 1] <- "orange"
def11.int <- leaflet(pitt) %>%
  ...
  addLegend(
    title = "Definition 11 - Increasing", 
    position = c("bottomleft"),
    colors = c("orange", "skyblue", "powderblue", "slategrey"),
    labels = c("Gentrifying", "Non-Gentrifying", "Gentrifiable Non-Gentrifying", "Tract Data Missing")
  )
...
def11.int <- leaflet(pitt) %>%
  ...
  addLegend(
    title = "Definition 11 - Decreasing", 
    position = c("bottomleft"),
    colors = c("orange", "skyblue", "powderblue", "slategrey"),
    labels = c("Gentrifying", "Non-Gentrifying", "Gentrifiable Non-Gentrifying", "Tract Data Missing")
  )
...
my.col <- rep("slategrey", 137)
my.col[pitt$def12.gentrifying == 0] <- "skyblue"
my.col[pitt$gentrifiable == 1] <- "powderblue"
my.col[pitt$def12.gentrifying == 1] <- "orange"
def12.int <- leaflet(pitt) %>%
  ...
  addLegend(
    title = "Definition 12 - Increasing", 
    position = c("bottomleft"),
    colors = c("orange", "skyblue", "powderblue", "slategrey"),
    labels = c("Gentrifying", "Non-Gentrifying", "Gentrifiable Non-Gentrifying", "Tract Data Missing")
  )
...
my.col <- rep("slategrey", 137)
my.col[pitt$def12.gentrifying2 == 0] <- "skyblue"
my.col[pitt$gentrifiable == 1] <- "powderblue"
my.col[pitt$def12.gentrifying2 == 1] <- "orange"
def12.int <- leaflet(pitt) %>%
  addPolygons(
    label=paste("Tract:", pitt$NAME, "Neighborhood:", pitt$neighborhood),
    labelOptions= labelOptions(direction = 'auto'),
  ...
  addLegend(
    title = "Definition 12 - Decreasing", 
    position = c("bottomleft"),
    colors = c("orange", "skyblue", "powderblue", "slategrey"),
    labels = c("Gentrifying", "Non-Gentrifying", "Gentrifiable Non-Gentrifying", "Tract Data Missing")
  )
