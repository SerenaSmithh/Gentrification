...
my.col <- rep("slategrey", 137)
my.col[pitt$def6.gentrifying.both == 0] <- "skyblue"
my.col[pitt$gentrifiable == 1] <- "powderblue"
my.col[pitt$def6.gentrifying.both == 1] <- "orange"
...
my.col <- rep("slategrey", 137)
my.col[pitt$def6.gentrifying.or == 0] <- "skyblue"
my.col[pitt$gentrifiable == 1] <- "powderblue"
my.col[pitt$def6.gentrifying.or == 1] <- "orange"
def6.int <- leaflet(pitt) %>%
  addPolygons(
    label=paste("Tract:", pitt$NAME, "Neighborhood:", pitt$neighborhood),
    labelOptions= labelOptions(direction = 'auto'),
...
my.col <- rep("slategrey", 137)
my.col[pitt$def12.gentrifying.both == 0] <- "skyblue"
my.col[pitt$gentrifiable == 1] <- "powderblue"
my.col[pitt$def12.gentrifying.both == 1] <- "orange"
...
my.col <- rep("slategrey", 137)
my.col[pitt$def12.gentrifying.or == 0] <- "skyblue"
my.col[pitt$gentrifiable == 1] <- "powderblue"
my.col[pitt$def12.gentrifying.or == 1] <- "orange"
def12.int <- leaflet(pitt) %>%
  addPolygons(
    label=paste("Tract:", pitt$NAME, "Neighborhood:", pitt$neighborhood),
    labelOptions= labelOptions(direction = 'auto'),
